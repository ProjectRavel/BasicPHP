            ...
            <main>
                <div class="container-fluid px-4">
                    ...
                    <ol class="breadcrumb mb-4">
                        <li class="breadcrumb-item active">Tampilan Data Barang Keluar</li>
                    </ol>
                    <button type="button" class="btn btn-primary mb-2" data-bs-toggle="modal" data-bs-target="#modalform">+ Pengeluaran Barang</button>
                    <div class="card mb-5">
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form method="post">
                                    <div class="mb-3">
                                        <label for="barangOption" class="form-label">Barang Keluar</label>
                                        <select name="barangKeluar" id="" class="form-control">
                                            <?php
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" required id="pembeli" name="pembeli" placeholder="Masukkan Nama pembeli">
                                    </div>

                                    <div class="mb-3">
                                        <label for="qtyOut" class="form-label">Jumlah Barang keluar</label>
                                        <input type="number" min="0" max="255" required class="form-control" id="qtyOut" name="qtyOut"></input>
                                    </div>
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-danger" data-bs-dismiss="modal">Batalkan</button>
                                        <button type="submit" class="btn btn-success" name="barangOut">+ Simpan Barang Keluar</button>
                                    </div>
                                </form>
                            </div>
                        </div>
